			<form id="form-addEvent">
				...
				<div class="row">
					<div class = "col-12">
						<input type="title" name="title" placeholder="Descrizione" class="input input-max-width" id="title" />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-12">
						<button class="button-orange" type="publishButton" id="publish" name="eventPublish" value="" onclick="formAction()" >PUBBLICA EVENTO</button> 
					</div>
				</div>
			</form>
