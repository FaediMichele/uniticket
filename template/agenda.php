<div class="col-12 contenuti">
    <?php 
			$eventsId = $templateParams["agenda"];
        ...
        <div class="col-11 cart">
            ...
            <a href="eventInfo.php?ID=<?php echo $eventsId[$index]["idEvent"];?>">
                <div class="row">
                    ...
                    <div class="col-3">
                        <p class="text-red font-size-red"><?php echo ($event["price"] * $eventsId[$index]["NumberTicket"]); ?>€</p>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12">
                        <p class="text-orange mb-0">Quantity : <?php echo $eventsId[$index]["NumberTicket"]; ?></p>
                    </div>
                </div>
            </a>
            <!--fine prima row-->
