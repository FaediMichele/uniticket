<div class="col-11 contenuti pt-3">
    <div class="row">
        <div class="col-12">
            <h1 align="center">Crea nuova sala</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <form id="form-addRoom" class="mt-3" action="phpFunctions/newRoom.php" method="POST"
                enctype="multipart/form-data">
                <!-- name -->
                <div class="row">
                    <div class="col-12">
                        <label for="name" id="lblName">*Nome sala</label>
                        <input type="text" name="name" placeholder="Nome sala es: SALA2" class="input input-max-width"
                            id="name" required>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="">
                            <label for="place" id="lblplace">*Locale</label>
                    ...
                    <div class="col-4">
                        <label for="capacity" id="lblCapacity">*Capienza</label>
