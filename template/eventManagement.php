<div class="col-12 contenuti border-bottom-son">
    ...
    <?php 
		...
		foreach($eventi as $evento): 
			...
			$img = $dbh->getEventImages($evento[0])[0];
    ...
    <div class="row justify-content-center">
        <div class="col-11">
            ...
            <div class="row">
                ...
                <div class="col-8 height-100 text-vertical-center-father p-0">
                    <p class="text-vertical-center-son text-center">
                        <img class="image image-pay " src="<?php echo $img["img"]; ?>">
                        <!--load first image-->
                    </p>
                </div>
                <div class="col-2 text-vertical-center-father height-100 p-0">
                    <p class="text-red font-size-red text-vertical-center-son text-center">
                        <?php echo $event["price"]; ?>€</p>
                </div>
            </div>
            <!--fine prima row-->
            <!--inizio seconda row-->
